...
document.addEventListener("DOMContentLoaded", function() {
    ...
    window.addEventListener('scroll', function() {
        ...
        <a href="https://smidgin-shop.myshopify.com/?srsltid=AfmBOoqJHd6Cccrm3CCQvzWikXUkEKywegonf-rx2u145ZDkvLJxZu05" class="px-3 py-3 bg-[#4164AD] shadow-[0_6px_12px_rgba(65,100,173,0.6)] rounded-xl text-white">BUY ONLINE</a>
      </div>
    </div>
  </div>
...
<div id="slideshow" class="">
  ...
  <!-- Header -->
  <div class="flex md:flex-row flex-col md:pt-16 justify-between md:pl-32 md:pr-48 items-center">
    ...
    <div class="self-center md:hidden md:pt-0 pt-8">
      <p class="md:pr-24 font-montserrat text-[34px] md:text-[50px]">SMIDGIN <span class="font-Baskervville text-[#4164AD]">LIGHT</span></p>
    </div>
  </div>
  ...
  <div class="md:px-32 px-7 md:pt-7 flex md:flex-row flex-col items-center justify-between">
    <div id="bottle" class="w-1/3 md:w-1/2 ">
      <img class="md:h-[1050] py-5 w-full h-auto md:w-[471px]" src="./sliki/light.jpeg"/>
    </div>
    <div class="md:w-1/2 md:pr-11 flex-col flex">
      ...
      <div class="flex md:flex-row flex-col md:space-x-9">
        ...
        <img class="md:w-1/3 w-2/3 mx-auto mt-5 md:mt-0" src="./sliki/lightNesto.png"/>
      </div>
    </div>
  </div>

  <!-- Next Product -->
  <a href="./xo.html" class="group">
    <div class="flex flex-col justify-center items-center mt-20 md:mt-44">
      <p class="text-[32px] md:text-[64px] font-montserrat">SMIDGIN <span class="font-Baskervville text-[#A24B1E]">XO</span></p>
      <img src="./sliki/xoPola.jpeg"       class="md:w-[300px] md:h-[400px] w-[220px] h-[320px]
