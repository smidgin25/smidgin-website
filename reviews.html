...
<script>
  ...
  // });
    ...
    <!-- Return offer -->
    <a href="javascript:history.back()" class="font-montserrat px-7 md:px-32"><i class="fa-solid fa-arrow-left pr-3"></i>BACK</a>
    <div class="flex flex-col  pb-14">
        <h1 class="font-Baskervville text-[32px] md:text-5xl px-7 md:px-32 pt-7">SMALL BATCH</h1>
    ...
    <div class="md:px-32 px-7 pt-10 flex md:flex-row flex-col items-center">
        <div id="levo" class="md:w-2/3">
            <div class="text-[17px] md:w-4/5 font-montserrat">
                <p><b>Nose:</b> Bright, fresh juniper with soft citrus.<br/><b>Palate:</b> Mellow, with subtle sweetness and spice.<br/><b>Finish:</b> Earthy, aromatic, well-balanced.<br/><br/>Their verdict? A strong gin with bold juniper character and a definite yes from the experts. We’re proud that our small-batch Macedonian gin stood tall in the land of gin. This summer, Smidgin heads into international competitions to represent the region with flavor, heart, and a whole lot of juniper. A Macedonian Original. A world-class gin.<br/><br/><a href="https://thegincooperative.com/" class="text-red-500 underline">Learn more about the Gin Cooperative →</a> </p>
            </div>
            <div>
                <p class="text-[30px] pt-14 font-Baskervville font-semibold">Scottish gin judge and author reviews Smidgin</p>
            </div>
        </div>
    ...
    <div class="flex md:flex-row flex-col justify-between items-start md:px-32 px-7 gap-9 pt-24">
        <div class="font-montserrat text-[17px] md:w-2/3">
