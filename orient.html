...
<div id="slideshow" class="">
  ...
  <!-- Header -->
  <div class="flex md:flex-row flex-col md:pt-16 justify-between md:pl-32 md:pr-40 items-center">
    ...
    <div class="md:hidden md:self-start self-center md:pt-0 pt-8">
      <p class="md:pr-24 font-montserrat text-[34px] md:text-[50px]">SMIDGIN <span class="font-Papyrus text-[#821A16]">ORIENT</span></p>
    </div>
  </div>
  ...
  <div class="md:px-32 px-7 md:pt-10 flex md:flex-row flex-col items-center justify-between">
    <div id="bottle" class="w-1/3 md:w-1/2">
      <img class="md:h-[1100] py-5 w-full h-auto md:w-[471px]" src="./sliki/orient.jpeg"/>
    </div>
    <div class="md:w-1/2 md:pr-11 flex-col flex">
      ...
      <div class="flex md:flex-row flex-col items-center md:space-x-9">
        ...
        <img class="md:w-1/3 w-2/3 mx-auto mt-5 md:mt-0" src="./sliki/orientNesto.png"/>
      </div>
    </div>
  </div>
