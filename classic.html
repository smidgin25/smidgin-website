  ...
  // });
    ...
    <div class="flex md:flex-row flex-col md:pt-16 justify-between md:pl-32 md:pr-36 items-center">
        ...
        <div class="self-center md:hidden  md:pt-0 pt-8">
            <p class="md:pr-24  font-montserrat text-[34px] md:text-[50px]">SMIDGIN <span class="font-Baskervville text-red-500">CLASSIC</span></p>
        </div>
    </div>
...
<div id="negroni" class="fixed inset-0 hidden flex items-center justify-center z-50">
  ...
  >
    ...
    <a href="./velvet.html" class="group">
